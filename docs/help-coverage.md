...
| Long-form qualification; Reload qualification; target/bindings/runtime/memory/pressure/cache/streams/decode; required-review statuses; safety record; Attempt history; failure/interruption recovery and preservation | `review-podcast-qualification` | macos/Sources/Studio/PodcastQualificationView.swift; macos/Sources/StudioCore/PodcastQualification.swift; tools/podcast_qualification.py |
